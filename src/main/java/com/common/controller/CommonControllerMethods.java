...
public class CommonControllerMethods {
    ...
    public ResponseEntity<List<EmployeePayrollDto>> getEmployeesByCampus(@PathVariable int campusId) {
        return ResponseEntity.ok(commonServiceMethods.getEmployeesByCampus(campusId));
    }
